...
<html>
	...
	<body>
		<form action="accounts_maker.php" method="post">
			...
			?>
			<span class="input-header">Username:</span> <br/>
			...
			<span class="input-header">Shipping address:</span> <br/>
			<input class="input-field" type="text" name="address" value="<?php echo $_GET['address']; ?>" placeholder="address" /><br/>
			<span class="input-header">Your @ email:</span> <br/>
			<input class="input-field" type="email" name="email" value="<?php echo $_GET['email']; ?>" placeholder="example@email.com" /><br/>
